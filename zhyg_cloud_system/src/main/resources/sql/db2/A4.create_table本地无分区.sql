...
(
  ...
  ttu_NUMERIC_of_resolutions      VARCHAR(50),
...
comment on column DEV_ATTRIBUTE_TABLE.ttu_display_light_present
  is 'TRUE/FALSE';
comment on column DEV_ATTRIBUTE_TABLE.ttu_NUMERIC_of_resolutions
  is '分辨率';
...
(
  ...
  nts_support_serial_NUMERICs VARCHAR(2),
  nts_open_serial_NUMERICs_jp VARCHAR(2),
  nts_open_serial_NUMERICs_rp VARCHAR(2),
...
comment on column DEV_SOFTWARE_INFO.nts_support_serial_NUMERICs
  is '应用是否支持冠字号 1:支持 0:不支持';
comment on column DEV_SOFTWARE_INFO.nts_open_serial_NUMERICs_jp
  is '应用是否开放冠字号日志打印功能，2-只打印真钞，1-真钞拒钞全部打印,0：不开通';
comment on column DEV_SOFTWARE_INFO.nts_open_serial_NUMERICs_rp
...
(
  ...
  cdm_cu_NUMERIC                 VARCHAR(100),
  cim_cu_NUMERIC                 VARCHAR(100),
...
comment on column DEV_STATUS_TABLE.cdm_cu_NUMERIC
  is '取款箱逻辑钞箱索引号';
comment on column DEV_STATUS_TABLE.cim_cu_NUMERIC
  is '存款箱逻辑钞箱索引号';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.MOD_NO
  is '模块编号';   
comment on column RPT_FAULT_DEV_MONTH_MOD.lv3_NUMERIC is '资源预警次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv4_NUMERIC is '资源耗尽次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv5_NUMERIC is '清机通知次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv6_NUMERIC is '营业故障次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv7_NUMERIC is '纸少次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv8_NUMERIC is '纸空次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv9_NUMERIC is '钞少次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv10_NUMERIC is '钞空次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv11_NUMERIC is '存款箱满次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv12_NUMERIC is '一般硬件故障次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv13_NUMERIC is '严重硬件故障次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv14_NUMERIC is '钞箱故障次数';
...
comment on column RPT_FAULT_DEV_MONTH_MOD.lv15_NUMERIC is '通讯故障次数';
