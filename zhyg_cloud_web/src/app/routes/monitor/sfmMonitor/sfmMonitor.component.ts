...
@Component({
    templateUrl: './sfmMonitor.html',
})
export class SfmMonitorComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private crdMonitorService: SfmMonitorService,
    ...
    ngOnInit() {
        ...
        this.monitorData.monitorType = '7'; // 监控类型为填单机
        ...
        this.reqdevlistdata.monitorType = '7';
    ...
    onMatrixEvent(matrixEventdata) {
        const modal = this.modal.open({
            title: '设备详细信息',
            content: SfmMonitorDetailComponent,
            width: '80%',
            componentParams: {
