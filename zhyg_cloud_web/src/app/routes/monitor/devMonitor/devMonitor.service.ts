...
export class DevMonitorService {
    ...
    initDevMonitor(params): Observable<any> {
        return this.http.get<any>(this.devMonitorUrl + '/devmonitor/initDevMonitor', {
            params: params
        });
    }

    getDevList(params): Observable<any> {
        return this.http.get<any>(this.devMonitorUrl + '/devmonitor/qryDevList', {
            params: params
        });
    }

    getDevStatus(params): Observable<any> {
        return this.http.get<any>(this.devMonitorUrl + '/devmonitor/qryDevStatus', {
            params: params
        });
    }

    updateUserMonitorSelect(params): Observable<any> {
        return this.http.post(this.devMonitorUrl + '/devmonitor/updateUsrMonitorSelect', params);
    }
    ...
    getDevFaultInfo(params): Observable<any> {
        return this.http.get<any>(this.devMonitorUrl + '/devmonitor/qryDevFaultInfo', {
            params: params
        });
    }

    getCashBoxInfo(params): Observable<any> {
        return this.http.get<any>(this.devMonitorUrl + '/devmonitor/qryCashBoxInfo', {
            params: params
        });
    }
