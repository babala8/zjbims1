...
@Component({
    selector: 'transPoundageInfo-factor',
    templateUrl: 'trans-poundage-info.html'
})
export class TransPoundageInfoComponent implements OnInit, OnChanges {

    rows= 'no,devNo,num,Amount,moreNum,poundage,reduceAmount,payAmount,count,transfer';
    _checked = true;
    startTime = '';
    endTime = '';
