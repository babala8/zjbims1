...
@Component({
    selector: 'shorten-Detail-factor',
    templateUrl: 'shorten-Detail-info.html'
})
export class ShortenDetailInfoComponent implements OnInit, OnChanges {
    ...
    getDevExcel() {
        ...
        console.log(params);
        this.workReport.shortenDetailInfo(params);
