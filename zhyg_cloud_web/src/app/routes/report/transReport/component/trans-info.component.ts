...
@Component({
    selector: 'trans-factor',
    templateUrl: 'trans-info.html'
})
export class TransInfoComponent implements OnInit, OnChanges {
    ...
    validateForm: FormGroup;
     rowsdata = 'rank,statDimensionsName,theBankCardWithdrawals,theBankCardDeposit,theBankCardTransfer,otherBankCardWithdrawals' +
         ',otherBankCardTransfer,qryNo,totalNo,totalMoney,averDayNo,averDayMoney,theBankIcqc,theBankNfaqc' +
         ',otherBankIcqc,otherBankNfaqc,theBankXjqc,otherBankXjqc';
