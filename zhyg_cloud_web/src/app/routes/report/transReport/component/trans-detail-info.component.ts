...
@Component({
    selector: 'transDetailInfo-factor',
    templateUrl: 'trans-detail-info.html'
})
export class TransDetailInfoComponent implements OnInit, OnChanges {
    ...
    getDevExcel() {
        ...
        // if (this.validateForm.controls.reportType.value == '5') {
        // if (  this.validateForm.controls.scopeTime.value == '' || this.validateForm.controls.scopeTime.value == null ) {
        //     this.message.error('请输入时间');
        //     return;
        // }else {
        //     this.startTime = this.date2String( new Date(this.validateForm.controls.scopeTime.value.toString().split(',')[0]));
        //     this.endTime = this.date2String( new Date(this.validateForm.controls.scopeTime.value.toString().split(',')[1]));
        // }
        // }
        ...
        console.log(params);
         ...
         this.transReport.devTransInfo(params);
        this.orgNo = '';
        this.orgNames = '';
    }
    /**
