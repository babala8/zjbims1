...
@Component({
    selector: 'doubtfulInfo-factor',
    templateUrl: 'doubtfulTrans-info.html'
})
export class DoubtfulTransInfoComponent implements OnInit, OnChanges {
    ...
    getDevExcel() {
        ...
        console.log(params);
        this.transreport.doubtfulTrans(params);
        this.orgNo = '';
        this.orgNames = '';
        // this.startTime = '';
        //     this.endTime = '';
