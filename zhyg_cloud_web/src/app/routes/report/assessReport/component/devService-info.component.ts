...
@Component({
    selector: 'devServiceInfo-factor',
    templateUrl: 'devService-info.html'
})
export class DevServiceInfoComponent implements OnInit, OnChanges {
    ...
    getDevExcel() {
        ...
        this.assessReport.serviceAssess(params);
