...
@Component({
    selector: 'adminDetailInfo-factor',
    templateUrl: 'admin-Detail-info.html'
})
export class AdminDetailInfoComponent implements OnInit, OnChanges {
    ...
    getDevExcel() {
        ...
        this.assessReport.qryAccess(params);
