...
export class TileComponent extends Tile implements AfterViewInit {
    ...
    fitImage($image) {
        ...
        var div1,div2, src = element.attr('src'), alt = element.attr('alt');
        ...
        div2 = $(`<div style="height:45px; display:flex; align-items:center;">
                            <p style="font-size: 17px; font-family: 'SimHei[Regular]';
        ...
        div1.appendTo(image_frame);
        div2.appendTo(image_frame);
